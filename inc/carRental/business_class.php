...
<div class="deals-section">
    <div class="container">
        ...
        <div class="section-header">
           ...
           <h2 class="section-title">Available Rides To Hire</h2>
                ...
                <a href="#" class="deal-link">
                    <div class="deal-card europe-theme">
                        <div class="deal-image">
                            <img src="./images/car/a1.jpg" alt="European city skyline at sunset">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">Rent Economy &nbsp; &nbsp; &nbsp;<span>></span></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card oceania-theme">
                        <div class="deal-image">
                            <img src="./images/car/Toyota-RAV4-Hybrid.jpg" alt="Sydney harbor with opera house and bridge">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">Rent Midsize SUV &nbsp; &nbsp; &nbsp;<span>></span></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/car/56.avif" alt="Traditional Japanese temple with cherry blossoms">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">Rent Standard SUV &nbsp; &nbsp; &nbsp;<span>></span></h3>
