    ...
    <style>
        ...
        #banner {
            ...
            background: linear-gradient(135deg, rgba(102, 126, 234, 0.8) 0%, rgba(118, 75, 162, 0.8) 100%),
                        url('./images/cruise/585.jpg') center/cover;
            overflow: hidden;
        }
/* 
        #banner::before {
    ...
    <div id="banner">
        ...
        <div class="container">
            <div class="hero-content">
                <h1> 
                   Where the <span class="highlight">Ocean Beckons</span> with Every Wave
                </h1>
            ...
            <form class="search-form">
                ...
                <div class="form-grid">
                    <div class="input-group">
                        ...
                        <input type="text" class="input-field" placeholder="Any Port" />
                    </div>
