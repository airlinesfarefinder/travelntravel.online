...
<div class="deals-section">
    <div class="container">
        ...
        <div class="section-header">
           ...
           <h2 class="section-title">Explore Premium Cruise Journeys</h2>
                ...
                <a href="#" class="deal-link">
                    <div class="deal-card europe-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/2150785290.jpg" alt="European city skyline at sunset">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">  American Coastline &nbsp; &nbsp; &nbsp;<span>></span></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card oceania-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/alaska.jpg" alt="Sydney harbor with opera house and bridge">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">Mediterranean Dreams &nbsp; &nbsp; &nbsp;  <span>></span></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/c3.webp" alt="Traditional Japanese temple with cherry blossoms">

                        </div>
                        <div class="deal-content">
                            <h3 class="deal-title">  Western Europe Highlights &nbsp; &nbsp; &nbsp; <span>></span></h3>
